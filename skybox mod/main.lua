...
-- Models (can add more)
E_MODEL_SKYBOX_ICOSPHERE = smlua_model_util_get_id("3DSkyboxIco_geo") -- This is actually an UV Sphere, blame past me for getting this wrong
...
function SpawnSkybox()
    ...
    if skyboxcheck == nil and p.currLevelNum == LEVEL_BITDW then
        spawn_non_sync_object(id_bhv3DSkybox, E_MODEL_SKYBOX_CUBE, l.pos.x, l.pos.y, l.pos.z, nil)
    elseif skyboxcheck == nil then
        spawn_non_sync_object(id_bhv3DSkybox, E_MODEL_SKYBOX_ICOSPHERE, l.pos.x, l.pos.y, l.pos.z, nil)
    end
end
