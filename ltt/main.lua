-- name: Lug's Tiny Torture Hardcore
-- description: The Harder Version of Lug's Delightful Dioramas; Original By: Lugmillord; Ported By: f_bell Using RM2Coop By: wRadion; 45 Degree Wallkicks By: Sunk; Healing 1-ups By: Blocky
...
vec3f_set(gLevelValues.starPositions.KingBobombStarPos, 304.0, 6000.0, -2685.0)
...
vec3f_set(gLevelValues.starPositions.MrIStarPos, 5100.0, 14070.0, -1909.0)
