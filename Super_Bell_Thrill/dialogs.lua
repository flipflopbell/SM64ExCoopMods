...
smlua_text_utils_dialog_replace(DIALOG_008,1,8,30,200, ("For some weird reason\
this game was programmed so\
if acts 1-5 are used for an\
object to show up, act 6\
will also be used so i had\
to hide pipes and star 1\
in this act, hope you\
understand."))
...
smlua_text_utils_dialog_replace(DIALOG_050,1,4,30,200, ("Some aditional information\
\
To collect the 7th star you\
must find a hidden place\
\
The 6th star is a challenge\
so expect SMG references\
\
One last thing is that i\
really wanted to make the\
silver stars spin but\
couldn't because of sm64\
and lua being weird."))
...
smlua_text_utils_dialog_replace(DIALOG_065,1,2,30,200, ("4 out of 8\
red coins are hidden.\
the other 4 are in\
some tricky places\
Also Press L if\
you're using free cam"))
...
smlua_text_utils_dialog_replace(DIALOG_167,1,6,30,200, ("*Credits*\
Rom Hack by Flipflop Bell\
Textures: BroDute,\
SMW Central and Nintendo\
Music:\
Daredevil, ShrooboidBrat\
SM3DW Overworld, Cackletta\
NSMB Underground, TheGael95\
\
Big thanks to the SM64\
rom hacking, Fast64\
and SM64EX Coop discord\
servers, Blocky.png and\
Woissil (for translating\
Kaze's MOPs), Bloxxel and\
Owokitty (for the custom\
Green Demon),\
Mr.NeedleMouse64 (camera.lua\
and help with warps)\
